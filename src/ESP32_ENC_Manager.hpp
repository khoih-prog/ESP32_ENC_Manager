...
#ifndef ESP32_ENC_Manager_hpp
#define ESP32_ENC_Manager_hpp
...
#define ESP32_ENC_MANAGER_VERSION           "ESP32_ENC_Manager v1.0.0"

#define ESP32_ENC_MANAGER_VERSION_MAJOR     1
#define ESP32_ENC_MANAGER_VERSION_MINOR     0
#define ESP32_ENC_MANAGER_VERSION_PATCH     0

#define ESP32_ENC_MANAGER_VERSION_INT       1000000

////////////////////////////////////////////////////

#include "ESP32_ENC_Manager_Debug.h"
...
class ESP32_EMParameter 
{
  ...
  private:
    ...
    friend class ESP32_ENC_Manager;
};
...
class ESP32_ENC_Manager
{
  public:

    ESP32_ENC_Manager(const char *iHostname = "");
