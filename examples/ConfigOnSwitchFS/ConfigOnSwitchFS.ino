...
void setup()
{
  ...
  Serial.println(ESP32_ENC_MANAGER_VERSION);
  ...
  ESP32_ENC_manager.setDebugOutput(true);

#if !USE_DHCP_IP
  // Set (static IP, Gateway, Subnetmask, DNS1 and DNS2) or (IP, Gateway, Subnetmask)
  ESP32_ENC_manager.setSTAStaticIPConfig(EthSTA_IPconfig);
#endif
  ...
  if (initialConfig)
  {
    ...
    //ESP32_ENC_manager.setConfigPortalTimeout(600);
